...
public:
    ...
    void SetTrajectory(const domain::Trajectory& traj);
    void UpdatePoint(int index, const domain::TrajectoryPoint& point);
...
private:
    void SetupUi();
    void PopulateTable();
    void HighlightRow(int row, domain::TrajectoryPointStatus status);
